...
//command to link this file with Main.cpp to run it : g++ -o BaselineFunctions.o -c BaselineFunctions.cpp
//command to link this file with Main.cpp to run it : g++ -o Main.o -c Main.cpp
//command to link MCTSFunctions.cpp with Main.cpp to run it : g++ -o MCTSFunctions.o -c MCTSFunctions.cpp
//command to link the object files and run the program : g++ -o Main Main.o BaselineFunctions.o MCTSFunctions.o
//command to run the program : ./Main